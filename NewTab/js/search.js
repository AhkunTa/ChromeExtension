let url = {
  ...
  jsonPLink: {
    ...
    google:
      "https://www.google.com/complete/search?cp=2&client=psy-ab&hl=zh-CN",
    sanliu0:
      "https://sug.so.360.cn/suggest?encodein=utf-8&encodeout=utf-8&format=json",
...
chrome.storage.local.get(
  ...
  function (data) {
    $(".search-engine").css({
      "background-image": "url(../img/" + data.searchEngineName + ".png)",
    });
